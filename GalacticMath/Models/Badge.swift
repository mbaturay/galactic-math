...
enum Badge: String, CaseIterable, Codable {
    // Kindergarten (topic badges at levels 4, 8, 12, 16, 20)
    case k_level5, k_level10, k_level15, k_level20, k_topic5, k_grad
    // Grade 1
    case g1_level5, g1_level10, g1_level15, g1_level20, g1_topic5, g1_grad
    // Grade 2
    case g2_level5, g2_level10, g2_level15, g2_level20, g2_topic5, g2_grad
    // Grade 3
    case g3_level5, g3_level10, g3_level15, g3_level20, g3_topic5, g3_grad
    // Grade 4
    case g4_level5, g4_level10, g4_level15, g4_level20, g4_topic5, g4_grad
    // Grade 5
    case g5_level5, g5_level10, g5_level15, g5_level20, g5_topic5, g5_grad
    // Grade 6
    case g6_level5, g6_level10, g6_level15, g6_level20, g6_topic5, g6_grad
    // Grade 7
    case g7_level5, g7_level10, g7_level15, g7_level20, g7_topic5, g7_grad
    // Special
    case rainbowScholar
    case speedDemon
    case onFire
    ...
    var emoji: String {
        ...
        case .g3_topic5: return "\u{2600}\u{FE0F}"
        ...
        case .g5_topic5: return "\u{1F396}\u{FE0F}"
        ...
        case .gameMaster: return "\u{1F3AE}"
        }
    }
    ...
    var name: String {
        ...
        case .g1_topic5: return "Sunflower"
        ...
        case .g3_topic5: return "Star Captain"
        ...
        case .g5_topic5: return "Inventor"
        ...
        case .g7_topic5: return "Grandmaster"
    ...
    var badgeDescription: String {
        ...
        case .gameMaster:     return "Complete any grade with 100% accuracy"
    ...
    var isSpecial: Bool {
        ...
        case .rainbowScholar, .speedDemon, .onFire, .sharpshooter,
             .perfectionist, .nightOwl, .earlyBird, .comebackKid, .weekWarrior, .gameMaster:
            return true
        default:
            return false
        }
    ...
    /// Returns the topic milestone badge earned when a topic's 4 levels are completed.
    /// Topic 0 completes at level 4, topic 1 at level 8, etc.
    static func milestoneBadge(grade: Grade, level: Int) -> Badge? {
        switch (grade, level) {
        case (.kindergarten, 4): return .k_level5
        case (.kindergarten, 8): return .k_level10
        case (.kindergarten, 12): return .k_level15
        case (.kindergarten, 16): return .k_level20
        case (.kindergarten, 20): return .k_topic5
        case (.grade1, 4): return .g1_level5
        case (.grade1, 8): return .g1_level10
        case (.grade1, 12): return .g1_level15
        case (.grade1, 16): return .g1_level20
        case (.grade1, 20): return .g1_topic5
        case (.grade2, 4): return .g2_level5
        case (.grade2, 8): return .g2_level10
        case (.grade2, 12): return .g2_level15
        case (.grade2, 16): return .g2_level20
        case (.grade2, 20): return .g2_topic5
        case (.grade3, 4): return .g3_level5
        case (.grade3, 8): return .g3_level10
        case (.grade3, 12): return .g3_level15
        case (.grade3, 16): return .g3_level20
        case (.grade3, 20): return .g3_topic5
        case (.grade4, 4): return .g4_level5
        case (.grade4, 8): return .g4_level10
        case (.grade4, 12): return .g4_level15
        case (.grade4, 16): return .g4_level20
        case (.grade4, 20): return .g4_topic5
        case (.grade5, 4): return .g5_level5
        case (.grade5, 8): return .g5_level10
        case (.grade5, 12): return .g5_level15
        case (.grade5, 16): return .g5_level20
        case (.grade5, 20): return .g5_topic5
        case (.grade6, 4): return .g6_level5
        case (.grade6, 8): return .g6_level10
        case (.grade6, 12): return .g6_level15
        case (.grade6, 16): return .g6_level20
        case (.grade6, 20): return .g6_topic5
        case (.grade7, 4): return .g7_level5
        case (.grade7, 8): return .g7_level10
        case (.grade7, 12): return .g7_level15
        case (.grade7, 16): return .g7_level20
        case (.grade7, 20): return .g7_topic5
        default: return nil
        }
    }
    ...
    /// Returns 6 badges per grade: 5 topic badges + 1 graduation
    static func badgesForGrade(_ grade: Grade) -> [Badge] {
        switch grade {
        case .kindergarten: return [.k_level5, .k_level10, .k_level15, .k_level20, .k_topic5, .k_grad]
        case .grade1: return [.g1_level5, .g1_level10, .g1_level15, .g1_level20, .g1_topic5, .g1_grad]
        case .grade2: return [.g2_level5, .g2_level10, .g2_level15, .g2_level20, .g2_topic5, .g2_grad]
        case .grade3: return [.g3_level5, .g3_level10, .g3_level15, .g3_level20, .g3_topic5, .g3_grad]
        case .grade4: return [.g4_level5, .g4_level10, .g4_level15, .g4_level20, .g4_topic5, .g4_grad]
        case .grade5: return [.g5_level5, .g5_level10, .g5_level15, .g5_level20, .g5_topic5, .g5_grad]
        case .grade6: return [.g6_level5, .g6_level10, .g6_level15, .g6_level20, .g6_topic5, .g6_grad]
        case .grade7: return [.g7_level5, .g7_level10, .g7_level15, .g7_level20, .g7_topic5, .g7_grad]
        }
    }
    ...
    static var totalCount: Int { return 58 }
}
